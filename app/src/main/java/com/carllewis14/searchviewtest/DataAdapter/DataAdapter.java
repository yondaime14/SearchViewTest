package com.carllewis14.searchviewtest.DataAdapter;
...
import com.carllewis14.searchviewtest.POJO.AndroidVersion;
import com.carllewis14.searchviewtest.R;

import java.util.ArrayList;

/**
 * Data Adapter for set POJO to views: i.e Textviews, image view etc
 */
...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolder> implements Filterable{
    ...
    public DataAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_recycler_row, viewGroup, false);
